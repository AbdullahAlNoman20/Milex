...
// Where a request starts, and where a refusal comes back to. A Line Manager
// lands at their own desk: they set the rate themselves or pass it up, the
// same two choices they have on a fresh recommendation. Only the Head of
// Department, who has nobody above them, starts at their own.
