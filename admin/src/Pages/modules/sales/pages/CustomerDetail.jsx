    ...
    <div className="w-full max-w-[1400px] mx-auto px-3 sm:px-4 md:px-6 space-y-4 sm:space-y-5 pt-4 pb-12 overflow-x-hidden">
      ...
      <div className="flex flex-col lg:flex-row gap-5 items-start">
        ...
        <div className="w-full lg:w-[360px] shrink-0 space-y-5">
          ...
          {/* A re-quote on a live customer is its own short episode, and the
              onboarding that made them a customer stays untouched below it. */}
          {Array.isArray(customer.rateProcessHistory) &&
            customer.rateProcessHistory.length > 0 && (
              <AuditTrail
